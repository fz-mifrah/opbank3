...
class OperationResourceIT {
    ...
    private static final EtatOperation DEFAULT_ETAT_OPERATION = EtatOperation.EnCours;
    private static final EtatOperation UPDATED_ETAT_OPERATION = EtatOperation.Valide;
